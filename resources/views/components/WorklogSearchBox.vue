                    ...
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input v-model="searchQuery" type="text" class="form-control"
                                placeholder="Enter Epic/Task Title" @input="
                                    filterWorklogs();
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="input-group date mr-2" id="logDatePickerFrom" data-target-input="nearest">
                                <input type="text" id="logDateFrom" class="form-control datetimepicker-input"
                                    data-target="#logDatePickerFrom" placeholder="From" />
                                <div class="input-group-append" data-target="#logDatePickerFrom"
                            ...
                            <!-- Plan Start Date (To) -->
                            <div class="input-group date ml-2" id="logDatePickerTo" data-target-input="nearest">
                                <input type="text" id="logDateTo" class="form-control datetimepicker-input"
                                    data-target="#logDatePickerTo" placeholder="To" />
                                <div class="input-group-append" data-target="#logDatePickerTo"
                                    data-toggle="datetimepicker">
                                    <div class="input-group-text">
                                        <i class="fa fa-calendar"></i>
                                    </div>
