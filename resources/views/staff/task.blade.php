    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="taskTreeTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Epic/Task</th>
                                <th>Priority</th>
...
'resources/js/plugins/jszip/jszip.min.js',
])
...
<script>
    $(function() {
        var table = $("#taskTreeTable").DataTable({
            "responsive": true,
            "lengthChange": false,
            "autoWidth": false,
            ...
            "columnDefs": [{
                    "orderable": false, // Tắt sắp xếp cho tất cả các cột
                    "targets": '_all'
                },
                {
                    "targets": [4, 5, 6, 7, 8, 9], // Những cột muốn ẩn (ví dụ cột date và progress)
                    "visible": false // Ẩn cột date và progress khi load trang
                }
            ],
