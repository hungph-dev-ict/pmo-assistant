...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ $project->name }} - Project Worklog</li>
@endsection
...
@section('content')
    <div id="worklog-management-list">
        <worklog-management-container></worklog-management-container>
    </div>
@endsection
