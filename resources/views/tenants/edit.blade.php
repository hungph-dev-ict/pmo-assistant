            ...
            <div class="card-body">
                <form action="{{ route('tenants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-3">
                            <img id="previewTenantLogo" src="{{ $tenant->logo_base64 }}" alt="PreviewLogo" class="img-fluid img-thumbnail"
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="haAccount" name="ha_account"
                        class="form-control @error('ha_account') is-invalid @enderror" value="{{ old('ha_account', $tenant->headUser->account) }}">
                    @error('ha_account')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    ...
                    <!-- Thẻ img để hiển thị ảnh xem trước -->
                    <div class="mt-3">
                        <img id="previewHaAvatar" src="{{ $tenant->ha_avatar_base64 }}" alt="PreviewAvatar" class="img-fluid img-thumbnail"
