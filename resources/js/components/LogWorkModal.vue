                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            class="form-control"
                            :value="task?.assignee?.account || 'N/A'"
                            disabled
                        />
                    </div>
                    ...
                    <div class="form-group position-relative">
                        ...
                        <i
                            v-if="task?.actual_effort > task?.actual_effort"
                    ...
                    <div class="form-group">
                        <label
                            >Log Date <span style="color: red">*</span></label
                        >
                        <div
